...
class ProductoSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Producto
        fields = ('nombre', 'precio', 'estado_producto', 'latitud', 'longitud', 'tipo_envio', 'descripcion', 'vendido_por', 'tiene_tags', 'num_likes', 'contenido_multimedia')

class UserProfileSerializer(serializers.HyperlinkedModelSerializer):
    usuario_valorado_estrella = ValidacionEstrellaSerializer(many=True, read_only=True)
